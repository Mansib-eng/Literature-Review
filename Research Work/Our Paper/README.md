...
**Abstract**
In the digital age, human attention is increasingly fragmented due to constant interaction with technology. This has led to a growing need for intelligent systems capable of monitoring, assessing, and enhancing attention and focus across various digital contexts. Artificial Intelligence (AI), particularly machine learning and deep learning models, has shown promise in automating the detection and evaluation of cognitive states such as attention and mental load. This systematic review examines the current landscape of AI-powered methods for assessing attention and focus in digital environments. We followed PRISMA guidelines to identify and filter relevant literature across five major databases, ultimately reviewing 19 high-quality papers. The review analyzes trends in AI methodologies, common data sources, evaluation metrics, and contextual applications such as online learning, mobile usage, and social media. Key findings reveal a reliance on supervised learning techniques, increased interest in multi-modal data, and a need for more standardized datasets. The paper concludes by outlining current challenges and recommending directions for future research, including ethical considerations, real-time deployment, and cross-domain generalization.

**1. Introduction**
Attention and focus are essential components of human cognition, playing a critical role in learning, productivity, and mental well-being. However, the rapid rise of digital technology—ranging from smartphones and social media platforms to online education systems—has introduced new challenges for sustaining attention. This shift has prompted researchers to explore the potential of AI-driven technologies for non-intrusively measuring and interpreting attention-related behaviors.

Recent advances in machine learning, deep learning, and cognitive computing offer a variety of techniques for modeling human attention through behavioral, physiological, and interaction-based signals. These systems are being increasingly deployed in educational environments, digital well-being tools, human-computer interaction systems, and mental health diagnostics. However, despite the growing body of research in this domain, there is limited consolidation of findings regarding the specific AI methods used, their effectiveness, and the contexts in which they are applied.

This systematic literature review aims to bridge that gap by critically analyzing studies that leverage AI-based approaches for assessing attention and focus in digital contexts. The goal is to map the technological landscape, highlight recurring patterns, identify research gaps, and offer recommendations for advancing the field.
